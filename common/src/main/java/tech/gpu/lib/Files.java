...
public interface Files {
    ...
    public enum FileType {
         ...
         * compatible with some functionality on Android, such as {@link Audio#newSound(File)} and
         * {@link Audio#newMusic(File)}.
         */
        Classpath,
     ...
     * @throws tech.gpu.lib.ex.GpuRuntimeException if the type is classpath or internal and the file does not exist.
     * @see FileType
     */
