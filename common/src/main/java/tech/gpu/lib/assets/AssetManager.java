...
import tech.gpu.lib.assets.loaders.*;
import tech.gpu.lib.assets.loaders.resolvers.InternalFileHandleResolver;
...
import tech.gpu.lib.graphics.g2d.PolygonRegion;
import tech.gpu.lib.graphics.g2d.PolygonRegionLoader;
import tech.gpu.lib.graphics.g2d.TextureAtlas;
import tech.gpu.lib.graphics.g3d.Model;
import tech.gpu.lib.graphics.g3d.loader.G3dModelLoader;
import tech.gpu.lib.graphics.g3d.loader.ObjLoader;
import tech.gpu.lib.scenes.scene2d.ui.Skin;
import tech.gpu.lib.utils.*;
import tech.gpu.lib.utils.ObjectMap.Entry;
import tech.gpu.lib.utils.StringBuilder;
import tech.gpu.lib.utils.async.AsyncExecutor;
import tech.gpu.lib.utils.async.ThreadUtils;
...
public class AssetManager implements Disposable {
    ...
    Logger log = LoggerFactory.getLogger("AssetManager");
...
//            setLoader(ParticleEffect.class, new ParticleEffectLoader(resolver));
            setLoader(tech.gpu.lib.graphics.g3d.particles.ParticleEffect.class,
                    new tech.gpu.lib.graphics.g3d.particles.ParticleEffectLoader(resolver));
     ...
     * @return the asset
     * @throws GpuRuntimeException if the asset is not loaded
     */
    ...
    /**
     * @param fileName the asset file name
     * @param required true to throw GpuRuntimeException if the asset is not loaded, else is returned
     * @return the asset or if it is not loaded and required is false
     */
    public synchronized <T> T get(String fileName, boolean required) {
        ...
        if (required) throw new GpuRuntimeException("Asset not loaded: " + fileName);
        return null;
    }
    ...
    public synchronized void unload(String fileName) {
        ...
        if (type == null) throw new GpuRuntimeException("Asset not loaded: " + fileName);
     ...
     * @return The loader capable of loading the type, or if none exists
     */
     ...
     *
     * @param type     The type of the loader to get
     * @param fileName The filename of the asset to get a loader for, or to get the default loader
     * @return The loader capable of loading the type and filename, or if none exists
     */
    ...
    public synchronized <T> void load(String fileName, Class<T> type, AssetLoaderParameters<T> parameter) {
        ...
        if (loader == null) throw new GpuRuntimeException("No loader for type: " + ClassReflection.getSimpleName(type));
        ...
        for (int i = 0; i < loadQueue.size; i++) {
            ...
            if (desc.fileName.equals(fileName) && !desc.type.equals(type)) throw new GpuRuntimeException(
        ...
        if (otherType != null && !otherType.equals(type))
            throw new GpuRuntimeException("Asset with name '" + fileName + "' already loaded, but has different type (expected: "
...
//        if (ApplicationEnvironment.app.getType() == Application.ApplicationType.WebGL) return update();
    ...
    private void addTask(AssetDescriptor assetDesc) {
        ...
        if (loader == null)
            throw new GpuRuntimeException("No loader for type: " + ClassReflection.getSimpleName(assetDesc.type));
    ...
    private void handleTaskError(Throwable t) {
        ...
        if (tasks.isEmpty()) throw new GpuRuntimeException(t);
        ...
        if (listener != null)
            ...
            throw new GpuRuntimeException(t);
    }
     ...
     *
     * @param type   the type of the asset
     * @param suffix the suffix the filename must have for this loader to be used or to specify the default loader.
     * @param loader the loader
     */
    ...
    /**
     * @return the dependencies of an asset or if the asset has no dependencies.
     */
