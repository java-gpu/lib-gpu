...
import tech.gpu.lib.utils.IntSet.IntSetIterator;
import tech.gpu.lib.utils.JsonValue.PrettyPrintSettings;
import tech.gpu.lib.utils.JsonWriter.OutputType;
import tech.gpu.lib.utils.ObjectMap.Entry;
import tech.gpu.lib.utils.reflect.*;
 ...
 * https://libApplicationEnvironment.com/wiki/utils/reading-and-writing-json
 *
 * @author Nathan Sweet
 */
public class Json {
     ...
     * deserialization. Set to to never output this information, but be warned that deserialization may fail. Default is
     * "class".
     */
    ...
    /**
     * @param knownType   May be if the type is unknown.
     * @param elementType May be if the type is unknown.
     */
    ...
    /**
     * @param type May be if the type is unknown.
     * @return May be null.
     */
    ...
    /**
     * @param object      May be if the field is static.
     * @param elementType May be if the type is unknown.
     */
