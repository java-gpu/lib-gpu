...
public class XmlReader {
    ...
    static public class Element {
        ...
        /**
         * @throws GpuRuntimeException if the attribute was not found.
         */
        public String getAttribute(String name) {
            if (attributes == null)
                throw new GpuRuntimeException("Element " + this.name + " doesn't have attribute: " + name);
        ...
        /**
         * @throws GpuRuntimeException if the element has no children.
         */
        public Element getChild(int index) {
            if (children == null) throw new GpuRuntimeException("Element has no children: " + name);
        ...
        public void replaceChild(Element child, Element replacement) {
            ...
            if (!children.replaceFirst(child, true, replacement)) {
                throw new GpuRuntimeException("Element '" + name + "' does not contain child: " + child);
            }
        }
         ...
         *
         * @throws GpuRuntimeException if no attribute or child was not found.
         */
        public String get(String name) {
            String value = get(name, null);
            if (value == null)
                throw new GpuRuntimeException("Element " + this.name + " doesn't have attribute or child: " + name);
            return value;
        }
