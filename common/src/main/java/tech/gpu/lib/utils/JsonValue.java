...
public class JsonValue implements Iterable<JsonValue> {
    ...
    private JsonValue(JsonValue value, JsonValue parent) {
        type = value.type;
     ...
     *
     * @return May be if this value is null.
    ...
    /**
     * @param stringValue May be if the string representation is the string value of the double (eg, no leading zeros).
     */
    ...
    /**
     * @param stringValue May be if the string representation is the string value of the long (eg, no leading zeros).
     */
