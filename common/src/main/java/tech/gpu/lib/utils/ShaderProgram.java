...
public class ShaderProgram implements Disposable {
    ...
    public ShaderProgram(String vertexShader, String fragmentShader) {
        ...
        if (isCompiled()) {
            fetchAttributes();
            fetchUniforms();
            addManagedShader(ApplicationEnvironment.app, this);
        }
    }
...
//        GL20 gl = ApplicationEnvironment.gl20;
...
//        if (linked == 0) {
//// ApplicationEnvironment.gl20.glGetProgramiv(program, GL20.GL_INFO_LOG_LENGTH, intbuf);
//// int infoLogLength = intbuf.get(0);
//// if (infoLogLength > 1) {
//            log = ApplicationEnvironment.gl20.glGetProgramInfoLog(program);
//// }
//            return -1;
//        }
//
...
//            location = ApplicationEnvironment.gl20.glGetUniformLocation(program, name);
...
//        if (shaders.get(ApplicationEnvironment.app) != null) shaders.get(ApplicationEnvironment.app).removeValue(this, true);
        // TODO
    }
...
//        if (ApplicationEnvironment.gl20 == null) return;
//
...
//        }
    ...
    public static int getNumManagedShaderPrograms() {
        return shaders.get(ApplicationEnvironment.app).size;
    }
...
//        ((Buffer) params).clear();
//        ApplicationEnvironment.gl20.glGetProgramiv(program, GL20.GL_ACTIVE_UNIFORMS, params);
...
//            params.put(0, 1);
//            ((Buffer) type).clear();
//            String name = ApplicationEnvironment.gl20.glGetActiveUniform(program, i, params, type);
//            int location = ApplicationEnvironment.gl20.glGetUniformLocation(program, name);
//            uniforms.put(name, location);
...
//        ((Buffer) params).clear();
//        ApplicationEnvironment.gl20.glGetProgramiv(program, GL20.GL_ACTIVE_ATTRIBUTES, params);
...
//            params.put(0, 1);
//            ((Buffer) type).clear();
//            String name = ApplicationEnvironment.gl20.glGetActiveAttrib(program, i, params, type);
//            int location = ApplicationEnvironment.gl20.glGetAttribLocation(program, name);
//            attributes.put(name, location);
