...
//        HdpiUtils.glViewport(screenX, screenY, screenWidth, screenHeight);
    ...
    public Vector2 toScreenCoordinates(Vector2 worldCoords, Matrix4 transformMatrix) {
        ...
        camera.project(tmp, screenX, screenY, screenWidth, screenHeight);
        tmp.y = ApplicationEnvironment.graphics.getHeight() - tmp.y;
        worldCoords.x = tmp.x;
        worldCoords.y = tmp.y;
        return worldCoords;
    }
    ...
    public int getRightGutterWidth() {
        return ApplicationEnvironment.graphics.getWidth() - (screenX + screenWidth);
    }
    ...
    public int getTopGutterHeight() {
        return ApplicationEnvironment.graphics.getHeight() - (screenY + screenHeight);
    }
}
