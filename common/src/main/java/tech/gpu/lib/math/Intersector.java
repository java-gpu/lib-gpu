...
package tech.gpu.lib.math;

import tech.gpu.lib.math.Plane.PlaneSide;
import tech.gpu.lib.math.collision.BoundingBox;
import tech.gpu.lib.math.collision.OrientedBoundingBox;
...
public final class Intersector {
	 ...
	 * @param mtv A Minimum Translation Vector to fill in the case of a collision, or (optional).
	 * @return Whether the line segment and the circle intersect */
