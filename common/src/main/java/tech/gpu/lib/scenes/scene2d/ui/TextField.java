...
public class TextField extends Widget implements Disableable, Styleable<TextField.TextFieldStyle> {
    ...
    public TextField(String text, TextFieldStyle style) {
        setStyle(style);
        clipboard = ApplicationEnvironment.app.getClipboard();
        initialize();
        setText(text);
    ...
    public void next(boolean up) {
        ...
        while (true) {
            ...
            if (textField == null) {
                ApplicationEnvironment.input.setOnscreenKeyboardVisible(false);
                break;
            }
    ...
    static public class DefaultOnscreenKeyboard implements OnscreenKeyboard {
        public void show(boolean visible) {
            ApplicationEnvironment.input.setOnscreenKeyboardVisible(visible);
        }
    }
    ...
    public class TextFieldClickListener extends ClickListener {
        ...
        public boolean keyTyped(InputEvent event, char character) {
            ...
            if (UIUtils.isMac && ApplicationEnvironment.input.isKeyPressed(Keys.SYM)) return true;
