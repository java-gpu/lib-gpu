...
import tech.gpu.lib.scenes.scene2d.Touchable;
import tech.gpu.lib.scenes.scene2d.ui.Label.LabelStyle;
import tech.gpu.lib.scenes.scene2d.ui.Value.Fixed;
import tech.gpu.lib.scenes.scene2d.utils.Drawable;
import tech.gpu.lib.scenes.scene2d.utils.Layout;
import tech.gpu.lib.utils.*;
import tech.gpu.lib.utils.ShapeRenderer.ShapeType;
...
public class Table extends WidgetGroup {
    ...
    /**
     * @param background May be to clear the background.
     */
     ...
     *
     * @param actors May be or empty to add a stack without any actors.
     */
    ...
    /**
     * @return The skin that was passed to this table in its constructor, or if none was given.
     */
    public Skin getSkin() {
        return skin;
    }
