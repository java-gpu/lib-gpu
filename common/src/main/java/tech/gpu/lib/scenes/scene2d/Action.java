...
import tech.gpu.lib.scenes.scene2d.actions.DelayAction;
import tech.gpu.lib.scenes.scene2d.actions.TemporalAction;
...
abstract public class Action implements Poolable {
    /**
     * The actor this action is attached to, or if it is not attached.
     */
    protected Actor actor;

    /**
     * The actor this action targets, or if a target has not been set.
     */
     ...
     * method is called automatically when an action is added to an actor. This method is also called with when an action is
    ...
    /**
     * @return if the action is not attached to an actor.
     */
    ...
    /**
     * @return if the action has no target.
     */
