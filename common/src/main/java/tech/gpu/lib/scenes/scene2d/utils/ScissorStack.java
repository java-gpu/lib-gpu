...
//        }
    ...
    /**
     * @return if there are no scissors.
     */
    ...
    /**
     * Calculates a scissor rectangle using 0,0,ApplicationEnvironment.graphics.getWidth(),ApplicationEnvironment.graphics.getHeight() as the viewport.
     *
    ...
    public static void calculateScissors(Camera camera, Matrix4 batchTransform, Rectangle area, Rectangle scissor) {
        calculateScissors(camera, 0, 0, ApplicationEnvironment.graphics.getWidth(), ApplicationEnvironment.graphics.getHeight(), batchTransform, area, scissor);
    }
    ...
    public static Rectangle getViewport() {
        if (scissors.size == 0) {
            viewport.set(0, 0, ApplicationEnvironment.graphics.getWidth(), ApplicationEnvironment.graphics.getHeight());
            return viewport;
        } else {
            Rectangle scissor = scissors.peek();
