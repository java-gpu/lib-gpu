...
import tech.gpu.lib.utils.OrderedSet;
...
public class Selection<T> implements Disableable, Iterable<T> {
    ...
    /**
     * @param item May be (returns false).
     */
    ...
    /**
     * Makes a best effort to return the last item selected, else returns an arbitrary item or if the selection is empty.
     */
