...
public class SplitPane extends WidgetGroup implements Styleable<SplitPane.SplitPaneStyle> {
    ...
    public void setMinSplitAmount(float minAmount) {
        if (minAmount < 0 || minAmount > 1) throw new GpuRuntimeException("minAmount has to be >= 0 and <= 1");
    ...
    public void setMaxSplitAmount(float maxAmount) {
        if (maxAmount < 0 || maxAmount > 1) throw new GpuRuntimeException("maxAmount has to be >= 0 and <= 1");
