...
import tech.gpu.lib.graphics.g2d.BitmapFontCache;
import tech.gpu.lib.graphics.g2d.GlyphLayout;
...
public class Label extends Widget implements Styleable<Label.LabelStyle> {
    ...
    protected void computePrefSize(GlyphLayout layout) {
        ...
        if (wrap && ellipsis == null) {
            ...
            layout.setText(cache.getFont(), text, java.awt.Color.WHITE, width, Align.left, true);
        } else
    ...
    public void layout() {
        ...
        if (wrap || text.indexOf("\n") != -1) {
            ...
            layout.setText(font, text, 0, text.length(), java.awt.Color.WHITE, width, lineAlign, wrap, ellipsis);
        ...
        layout.setText(font, text, 0, text.length(), java.awt.Color.WHITE, textWidth, lineAlign, wrap, ellipsis);
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        cache.tint(new java.awt.Color(color.r, color.g, color.b, color.a));
    ...
    /**
     * When non-the text will be truncated "..." if it does not fit within the width of the label. Wrapping will not occur
