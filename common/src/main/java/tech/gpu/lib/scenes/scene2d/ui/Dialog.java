...
import tech.gpu.lib.math.Interpolation;
import tech.gpu.lib.scenes.scene2d.*;
import tech.gpu.lib.scenes.scene2d.actions.Actions;
import tech.gpu.lib.scenes.scene2d.ui.Label.LabelStyle;
import tech.gpu.lib.scenes.scene2d.ui.TextButton.TextButtonStyle;
import tech.gpu.lib.scenes.scene2d.utils.ChangeListener;
import tech.gpu.lib.scenes.scene2d.utils.FocusListener;
import tech.gpu.lib.utils.ObjectMap;

import static tech.gpu.lib.scenes.scene2d.actions.Actions.fadeOut;
import static tech.gpu.lib.scenes.scene2d.actions.Actions.sequence;
...
public class Dialog extends Window {
    ...
    /**
     * Adds a text button to the button table. will be passed to {@link #result(Object)} if this button is clicked. The
