...
import tech.gpu.lib.utils.Timer;
import tech.gpu.lib.utils.Timer.Task;

import static tech.gpu.lib.math.Interpolation.fade;
...
public class TooltipManager {
    ...
    static public TooltipManager getInstance() {
        if (files == null || files != ApplicationEnvironment.files) {
