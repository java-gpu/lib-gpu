...
import tech.gpu.lib.scenes.scene2d.utils.ActorGestureListener;
import tech.gpu.lib.scenes.scene2d.utils.ClickListener;
...
import static tech.gpu.lib.utils.Align.*;
...
public class Actor {
     ...
     * {@link Batch#draw(tech.gpu.lib.graphics.g2d.TextureRegion, float, float, float, float, float, float, float, float, float)
    ...
    public void act(float delta) {
        ...
        if (stage != null && stage.getActionsRequestRendering()) ApplicationEnvironment.graphics.requestRendering();
        try {
     ...
     * the specified point, or if no actor was hit. The point is specified in the actor's local coordinate system (0,0 is the
    ...
    /**
     * Returns the stage that this actor is currently in, or if not in a stage.
     */
     ...
     *
     * @param stage May be if the actor or any ascendant is no longer in a stage.
     */
    ...
    /**
     * Returns this actor or the first ascendant of this actor that is assignable with the specified type, or if none were
     * found.
     */
    ...
    /**
     * Returns the parent actor, or if not in a group.
     */
     ...
     *
     * @param parent May be if the actor has been removed from the parent.
     */
