...
import tech.gpu.lib.graphics.g2d.NinePatch;
...
public class Slider extends ProgressBar {
    ...
    boolean calculatePositionAndValue(float x, float y) {
        ...
        if (!ApplicationEnvironment.input.isKeyPressed(Keys.SHIFT_LEFT) && !ApplicationEnvironment.input.isKeyPressed(Keys.SHIFT_RIGHT))
            value = snap(value);
     ...
     *
     * @param values May be to disable snapping.
     */
