...
package tech.gpu.lib.scenes.scene2d;
...
import tech.gpu.lib.graphics.g2d.SpriteBatch;
import tech.gpu.lib.math.Matrix4;
import tech.gpu.lib.math.Rectangle;
import tech.gpu.lib.math.Vector2;
import tech.gpu.lib.scenes.scene2d.ui.Table;
import tech.gpu.lib.scenes.scene2d.ui.Table.Debug;
import tech.gpu.lib.scenes.scene2d.utils.FocusListener;
import tech.gpu.lib.scenes.scene2d.utils.FocusListener.FocusEvent;
import tech.gpu.lib.scenes.scene2d.utils.ScissorStack;
import tech.gpu.lib.utils.*;
import tech.gpu.lib.viewport.ScalingViewport;
import tech.gpu.lib.viewport.Viewport;
 ...
 * {@link Input#setInputProcessor(InputProcessor) ApplicationEnvironment.input.setInputProcessor}. An {@link InputMultiplexer} may
...
public class Stage implements Disposable, InputProcessor {
     ...
     */
    public Stage() {
        this(new ScalingViewport(Scaling.stretch, ApplicationEnvironment.graphics.getWidth(), ApplicationEnvironment.graphics.getHeight(), new OrthographicCamera()),
                new SpriteBatch());
        ownsBatch = true;
    }
    ...
    public Stage(Viewport viewport, Batch batch) {
        ...
        viewport.update(ApplicationEnvironment.graphics.getWidth(), ApplicationEnvironment.graphics.getHeight(), true);
    }
    ...
    private void drawDebug() {
        ...
        if (debugUnderMouse || debugParentUnderMouse) {
            screenToStageCoordinates(tempCoords.set(ApplicationEnvironment.input.getX(), ApplicationEnvironment.input.getY()));
     ...
     */
    public void act() {
        act(Math.min(ApplicationEnvironment.graphics.getDeltaTime(), 1 / 30f));
    }
    ...
    public boolean setScrollFocus(Actor actor) {
        ...
        FocusListener.FocusEvent event = Pools.obtain(FocusEvent::new);
        event.setStage(this);
     ...
     * @return May be if no actor was hit.
     */
    ...
    public Vector2 stageToScreenCoordinates(Vector2 stageCoords) {
        ...
        stageCoords.y = ApplicationEnvironment.graphics.getHeight() - stageCoords.y;
        return stageCoords;
    }
     ...
     *
     * @param debugTableUnderMouse May be for {@link Debug#none}.
     */
    ...
    protected boolean isInsideViewport(int screenX, int screenY) {
        ...
        screenY = ApplicationEnvironment.graphics.getHeight() - 1 - screenY;
