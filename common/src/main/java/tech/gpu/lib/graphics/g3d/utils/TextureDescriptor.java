...
//public class TextureDescriptor<T extends Texture> implements Comparable<TextureDescriptor<T>> {
public class TextureDescriptor<T extends Texture> implements Comparable<TextureDescriptor<T>> {
    ...
    public TextureDescriptor(final T texture, final TextureFilter minFilter, final TextureFilter magFilter,
                             final TextureWrap uWrap, final TextureWrap vWrap) {
    ...
    public void set(final T texture, final TextureFilter minFilter, final TextureFilter magFilter,
                    final TextureWrap uWrap, final TextureWrap vWrap) {
