 ...
 * {@link TextureRegion TextureRegions} and would be specified as:
 * <p>
...
public class Animation<T> {
    ...
    public Animation(float frameDuration, List<? extends T> keyFrames) {
        ...
        List<T> list = new ArrayList<>(keyFrames);
        T[] frames = (T[]) list.toArray();
        setKeyFrames(frames);
    }
     ...
     *                      correct type of array. Otherwise, it returns an Object[].
     */
    public Animation(float frameDuration, List<? extends T> keyFrames, PlayMode playMode) {
