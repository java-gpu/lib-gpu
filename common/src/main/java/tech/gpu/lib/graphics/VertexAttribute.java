...
public final class VertexAttribute {
    ...
    /**
     * the OpenGL type of each component
     */
...
//                alias, unit);
        // TODO
        this(usage, numComponents, -1, usage == Usage.ColorPacked, alias, unit);
    }
     ...
     * @param numComponents the number of components of this attribute, must be between 1 and 4.
     * @param type          the OpenGL type of each component. Since
...
//        return new VertexAttribute(Usage.ColorPacked, 4, GL20.GL_UNSIGNED_BYTE, true, ShaderProgram.COLOR_ATTRIBUTE);
        // TODO
        return new VertexAttribute(Usage.ColorPacked, 4, -1, true, ShaderProgram.COLOR_ATTRIBUTE);
    }

    public static VertexAttribute ColorUnpacked() {
//        return new VertexAttribute(Usage.ColorUnpacked, 4, GL20.GL_FLOAT, false, ShaderProgram.COLOR_ATTRIBUTE);
        // TODO
        return new VertexAttribute(Usage.ColorUnpacked, 4, -1, true, ShaderProgram.COLOR_ATTRIBUTE);
    }
