...
import tech.gpu.lib.graphics.g3d.utils.ShaderProvider;
 ...
 * {@link ModelBatch#begin(tech.gpu.lib.graphics.Camera)} and {@link ModelBatch#end()}. Therefor Renderable instances cannot
...
public class Renderable {
    ...
    /**
     * The bone transformations used for skinning, or if not applicable. When specified and the mesh contains one or more
     * {@link tech.gpu.lib.graphics.VertexAttributes.Usage#BoneWeight} vertex attributes, then the BoneWeight index is used as
