...
import tech.gpu.lib.graphics.g3d.attributes.ColorAttribute;
...
import tech.gpu.lib.graphics.g3d.utils.TextureProvider.FileTextureProvider;
    ...
    protected Node loadNode(ModelNode modelNode) {
        ...
        if (modelNode.parts != null) {
            for (ModelNodePart modelNodePart : modelNode.parts) {
                ...
                if (meshPart == null || meshMaterial == null) throw new GpuRuntimeException("Invalid node: " + node.id);
...
//            result.set(new BlendingAttribute(GL20.GL_SRC_ALPHA, GL20.GL_ONE_MINUS_SRC_ALPHA, mtl.opacity));
        ...
        if (mtl.textures != null) {
            for (ModelTexture tex : mtl.textures) {
                ...
                descriptor.uWrap = texture.getWrapU();
                descriptor.vWrap = texture.getWrapV();
     ...
     * @return The {@link Animation} with the specified id, or if not available.
     */
     ...
     * @return The {@link Material} with the specified id, or if not available.
     */
     ...
     * @return The {@link Node} with the specified id, or if not found.
     */
