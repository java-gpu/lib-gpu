...
import tech.gpu.lib.graphics.g3d.model.NodePart;
...
public class ModelBuilder {
     ...
     */
    public void begin() {
        if (model != null) throw new GpuRuntimeException("Call end() first");
        node = null;
        model = new Model();
        builders.clear();
    }
     ...
     */
    public Model end() {
        if (model == null) throw new GpuRuntimeException("Call begin() first");
