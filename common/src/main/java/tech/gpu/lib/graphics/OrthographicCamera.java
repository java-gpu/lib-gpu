...
public class OrthographicCamera extends Camera {
     ...
     * (ApplicationEnvironment.graphics.getWidth()/2, ApplicationEnvironment.graphics.getHeight()/2), with the y-axis pointing up or down.
     *
     * @param yDown whether y should be pointing down
     */
    public void setToOrtho(boolean yDown) {
        setToOrtho(yDown, ApplicationEnvironment.graphics.getWidth(), ApplicationEnvironment.graphics.getHeight());
    }
