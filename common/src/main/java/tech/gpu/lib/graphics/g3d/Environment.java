...
import tech.gpu.lib.graphics.g3d.attributes.DirectionalLightsAttribute;
import tech.gpu.lib.graphics.g3d.attributes.PointLightsAttribute;
import tech.gpu.lib.graphics.g3d.attributes.SpotLightsAttribute;
import tech.gpu.lib.graphics.g3d.environment.*;
...
public class Environment extends Attributes {
    ...
    public Environment add(BaseLight light) {
        if (light instanceof DirectionalLight)
            ...
            throw new GpuRuntimeException("Unknown light type");
        return this;
    }
