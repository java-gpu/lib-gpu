...
import tech.gpu.lib.utils.IntArray;
import tech.gpu.lib.utils.ShaderProgram;

import java.nio.Buffer;
import java.nio.FloatBuffer;

import static tech.gpu.lib.graphics.g2d.Sprite.SPRITE_SIZE;
import static tech.gpu.lib.graphics.g2d.Sprite.VERTEX_SIZE;
 ...
 * <code>cache.getProjectionMatrix().setToOrtho2D(0, 0, ApplicationEnvironment.graphics.getWidth(), ApplicationEnvironment.graphics.getHeight());</code><br>
 * <br>
 * Note that SpriteCache does not manage blending. You will need to enable blending (<i>ApplicationEnvironment.gl.glEnable(GL10.GL_BLEND);</i>) and
...
public class SpriteCache implements Disposable {
    ...
    public SpriteCache(int size, ShaderProgram shader, boolean useIndices) {
        ...
        projectionMatrix.setToOrtho2D(0, 0, ApplicationEnvironment.graphics.getWidth(), ApplicationEnvironment.graphics.getHeight());
    }
    ...
    public void begin() {
        ...
        // TODO
//        ApplicationEnvironment.gl20.glDepthMask(false);
...
//                mesh.render(shader, GL20.GL_TRIANGLES, offset, count);
     ...
     * <p>
     * Call this method with a argument to use the default shader.
     *
     * @param shader the {@link ShaderProgram} or to use the default shader.
     */
    ...
    /**
     * Returns the custom shader, or if the default shader is being used.
     */
