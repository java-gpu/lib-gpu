...
import tech.gpu.lib.graphics.g3d.attributes.FloatAttribute;
...
//            defaultCullFace = GL20.GL_FRONT;
    ...
    public final static String getDefaultVertexShader() {
        if (defaultVertexShader == null)
            defaultVertexShader = ApplicationEnvironment.files.classpath("com/badlogic/gdx/graphics/g3d/shaders/depth.vertex.glsl").readString();
    ...
    public final static String getDefaultFragmentShader() {
        if (defaultFragmentShader == null)
            defaultFragmentShader = ApplicationEnvironment.files.classpath("com/badlogic/gdx/graphics/g3d/shaders/depth.fragment.glsl").readString();
    ...
    public void begin(Camera camera, RenderContext context) {
        ...
        // ApplicationEnvironment.gl20.glEnable(GL20.GL_POLYGON_OFFSET_FILL);
        // ApplicationEnvironment.gl20.glPolygonOffset(2.f, 100.f);
    }

    @Override
    public void end() {
        super.end();
        // ApplicationEnvironment.gl20.glDisable(GL20.GL_POLYGON_OFFSET_FILL);
    }
