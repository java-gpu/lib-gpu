...
import tech.gpu.lib.graphics.g3d.particles.ParticleSorter;
import tech.gpu.lib.graphics.g3d.particles.renderers.ParticleControllerRenderData;
import tech.gpu.lib.utils.Array;
import tech.gpu.lib.utils.ArraySupplier;
...
public abstract class BufferedParticleBatch<T extends ParticleControllerRenderData> implements ParticleBatch<T> {
    ...
    protected BufferedParticleBatch(Class<T> type) {
        ...
        renderData = new tech.gpu.lib.utils.Array<T>(false, 10, type);
    }

    protected BufferedParticleBatch(ArraySupplier<T[]> arraySupplier) {
        this.sorter = new ParticleSorter.Distance();
        renderData = new tech.gpu.lib.utils.Array<T>(false, 10, arraySupplier);
    }
