...
import tech.gpu.lib.graphics.g3d.attributes.IntAttribute;
import tech.gpu.lib.graphics.g3d.attributes.TextureAttribute;
import tech.gpu.lib.graphics.g3d.shaders.BaseShader;
import tech.gpu.lib.graphics.g3d.shaders.DefaultShader;
...
public class ParticleShader extends BaseShader {
    ...
    public static String getDefaultVertexShader() {
        if (defaultVertexShader == null)
            defaultVertexShader = ApplicationEnvironment.files.classpath("com/badlogic/gdx/graphics/g3d/particles/particles.vertex.glsl").readString();
    ...
    public static String getDefaultFragmentShader() {
        if (defaultFragmentShader == null) defaultFragmentShader = ApplicationEnvironment.files
    ...
    public static class Setters {
        ...
        public final static Setter screenWidth = new Setter() {
            ...
            @Override
            public void set(BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
                shader.set(inputID, (float) ApplicationEnvironment.graphics.getWidth());
            }
        };
    ...
    public ParticleShader(final Renderable renderable, final Config config, final ShaderProgram shaderProgram) {
        ...
        if (!config.ignoreUnimplemented && (implementedFlags & materialMask) != materialMask)
            throw new GpuRuntimeException("Some attributes not implemented yet (" + materialMask + ")");
