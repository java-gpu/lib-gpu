...
import tech.gpu.lib.graphics.Mesh.VertexDataType;
...
import tech.gpu.lib.math.Affine2;
...
//    private int blendDstFuncAlpha = GL20.GL_ONE_MINUS_SRC_ALPHA;
    ...
    public SpriteBatch(int size, ShaderProgram defaultShader) {
        ...
        //TODO VertexDataType vertexDataType = (ApplicationEnvironment.gl30 != null) ? VertexDataType.VertexBufferObjectWithVAO : defaultVertexDataType;
        VertexDataType vertexDataType = defaultVertexDataType;
    ...
    public void begin() {
        ...
        // TODO
//        ApplicationEnvironment.gl.glDepthMask(false);
...
//            if (blendSrcFunc != -1)
//                ApplicationEnvironment.gl.glBlendFuncSeparate(blendSrcFunc, blendDstFunc, blendSrcFuncAlpha, blendDstFuncAlpha);
//        }
//
