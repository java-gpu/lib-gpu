...
import tech.gpu.lib.math.EarClippingTriangulator;
...
/**
 * loads {@link PolygonRegion PolygonRegions} using a {@link tech.gpu.lib.graphics.g2d.PolygonRegionLoader}
 *
 * @author dermetfan
 */
public class PolygonRegionLoader extends SynchronousAssetLoader<PolygonRegion, PolygonRegionLoader.PolygonRegionParameters> {
    ...
    public Array<AssetDescriptor> getDependencies(String fileName, FileHandle file, PolygonRegionParameters params) {
        ...
        try {
            ...
            throw new GpuRuntimeException("Error reading " + fileName, e);
        }
    ...
    public PolygonRegion load(TextureRegion textureRegion, FileHandle file) {
        ...
        try {
            ...
            throw new GpuRuntimeException("Error reading polygon shape file: " + file, ex);
        } finally {
            StreamUtils.closeQuietly(reader);
        }
        throw new GpuRuntimeException("Polygon shape not found: " + file);
    }
