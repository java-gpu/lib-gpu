...
public class TextureAtlas implements Disposable {
    ...
    public TextureAtlas(String internalPackFile) {
        this(ApplicationEnvironment.files.internal(internalPackFile));
    }
    ...
    public void load(TextureAtlasData data) {
        ...
        for (TextureAtlasData.Page page : data.pages) {
            if (page.texture == null)
                page.texture = new Texture(ApplicationEnvironment.app, page.textureFile.file(), page.format, page.useMipMaps);
    ...
    static public class TextureAtlasData {
        ...
        public void load(FileHandle packFile, FileHandle imagesDir, boolean flip) {
            ...
            pageFields.put("format", new Field<Page>() {
                public void parse(Page page) {
                    page.format = PixelFormat.valueOf(entry[1]);
                }
            });
...
//                    page.useMipMaps = page.minFilter.isMipMap();
        ...
        static public class Page {
            public String name;
            /**
             * May be if this page isn't associated with a file. In that case, {@link #texture} must be set.
             */
            public FileHandle textureFile;
            /**
             * May be if the texture is not yet loaded.
             */
