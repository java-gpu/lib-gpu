...
public class CameraInputController extends GestureDetector {
    ...
    protected static class CameraGestureListener extends GestureAdapter {
        ...
        public boolean zoom(float initialDistance, float distance) {
            ...
            float w = ApplicationEnvironment.graphics.getWidth(), h = ApplicationEnvironment.graphics.getHeight();
    ...
    protected CameraInputController(final CameraGestureListener gestureListener, final Camera camera) {
        super(ApplicationEnvironment.app, gestureListener);
    ...
    public void update() {
        if (rotateRightPressed || rotateLeftPressed || forwardPressed || backwardPressed) {
            final float delta = ApplicationEnvironment.graphics.getDeltaTime();
    ...
    public boolean touchDragged(int screenX, int screenY, int pointer) {
        ...
        final float deltaX = (screenX - startX) / ApplicationEnvironment.graphics.getWidth();
        final float deltaY = (startY - screenY) / ApplicationEnvironment.graphics.getHeight();
        startX = screenX;
        startY = screenY;
