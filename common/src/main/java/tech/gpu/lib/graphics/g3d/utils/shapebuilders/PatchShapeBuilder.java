...
package tech.gpu.lib.graphics.g3d.utils.shapebuilders;

import tech.gpu.lib.graphics.g3d.utils.MeshPartBuilder;
import tech.gpu.lib.graphics.g3d.utils.MeshPartBuilder.VertexInfo;
...
public class PatchShapeBuilder extends BaseShapeBuilder {
    ...
    public static void build(MeshPartBuilder builder, VertexInfo corner00, VertexInfo corner10, VertexInfo corner11,
        ...
        if (divisionsU < 1 || divisionsV < 1) {
            throw new GpuRuntimeException("divisionsU and divisionV must be > 0, u,v: " + divisionsU + ", " + divisionsV);
        }
