...
import tech.gpu.lib.graphics.g3d.particles.emitters.Emitter;
import tech.gpu.lib.graphics.g3d.particles.influencers.Influencer;
import tech.gpu.lib.graphics.g3d.particles.renderers.ParticleControllerRenderer;
...
public class ParticleController implements Json.Serializable, ResourceData.Configurable {
     ...
     */
    public void update() {
        update(ApplicationEnvironment.graphics.getDeltaTime());
    }
