...
//            batch.setBlendFunction(GL20.GL_SRC_ALPHA, GL20.GL_ONE_MINUS_SRC_ALPHA);
    ...
    /**
     * @return Whether this ParticleEmitter automatically returns the {@link tech.gpu.lib.graphics.g2d.Batch Batch}'s blend
    ...
    /**
     * Set whether to automatically return the {@link tech.gpu.lib.graphics.g2d.Batch Batch}'s blend function to the
    ...
    static public class IndependentScaledNumericValue extends ScaledNumericValue {
        ...
        public void load(BufferedReader reader) throws IOException {
            ...
            if (line.contains("independent"))
                ...
                ApplicationEnvironment.app.error("ParticleEmitter", errorMessage);
