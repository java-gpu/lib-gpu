...
public class ParticleEffect implements Disposable {
    ...
    /**
     * Allocates all emitters particles. See {@link tech.gpu.lib.graphics.g2d.ParticleEmitter#preAllocateParticles()}
     */
    ...
    public void loadEmitters(FileHandle effectFile) {
        ...
        try {
            ...
            throw new GpuRuntimeException("Error loading effect: " + effectFile, ex);
        } finally {
    ...
    protected Texture loadTexture(FileHandle file) {
        return new Texture(ApplicationEnvironment.app, file.file(), false);
    }
    ...
    /**
     * Sets the {@link tech.gpu.lib.graphics.g2d.ParticleEmitter#setCleansUpBlendFunction(boolean) cleansUpBlendFunction}
     * parameter on all {@link tech.gpu.lib.graphics.g2d.ParticleEmitter ParticleEmitters} currently in this ParticleEffect.
     * <p>
