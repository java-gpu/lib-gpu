...
public class ResourceData<T> implements Json.Serializable {
     ...
     * of indices addressing a given {@link tech.gpu.lib.graphics.g3d.particles.ResourceData.AssetData} in the
     * {@link ResourceData}
     */
    ...
    public static class AssetData<T> implements Json.Serializable {
        ...
        public void read(Json json, JsonValue jsonData) {
            ...
            try {
                ...
                throw new GpuRuntimeException("Class not found: " + className, e);
            }
        }
    }
