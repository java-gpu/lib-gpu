...
public class FileHandle {
    ...
    /**
     * @return the path of the file as specified on construction, e.g. ApplicationEnvironment.files.internal("dir/file.png") -> dir/file.png.
    ...
    public File file() {
        if (type == FileType.External)
            return new File(ApplicationEnvironment.files.getExternalStoragePath(), file.getPath());
        return file;
    }
     ...
     *
     * @throws GpuRuntimeException if the file handle represents a directory, doesn't exist, or could not be read.
     */
    public InputStream read() {
        if (type == FileType.Classpath || (type == FileType.Internal && !file().exists())
            ...
            if (input == null) throw new GpuRuntimeException("File not found: " + file + " (" + type + ")");
            return input;
        }
        try {
            ...
            if (file().isDirectory())
                throw new GpuRuntimeException("Cannot open a stream to a directory: " + file + " (" + type + ")", ex);
            throw new GpuRuntimeException("Error reading file: " + file + " (" + type + ")", ex);
        }
    }
    ...
    public Reader reader(String charset) {
        ...
        try {
            ...
            throw new GpuRuntimeException("Error reading file: " + this, ex);
        }
    }
     ...
     *
     * @param charset If the default charset is used.
     * @throws GpuRuntimeException if the file handle represents a directory, doesn't exist, or could not be read.
     */
    public String readString(String charset) {
        ...
        try {
            ...
            throw new GpuRuntimeException("Error reading layout file: " + this, ex);
        } finally {
     ...
     *
     * @throws GpuRuntimeException if this file handle represents a directory, doesn't exist, or could not be read, or memory
    ...
    public ByteBuffer map(MapMode mode) {
        if (type == FileType.Classpath) throw new GpuRuntimeException("Cannot map a classpath file: " + this);
        ...
        try {
            ...
            throw new GpuRuntimeException("Error memory mapping file: " + this + " (" + type + ")", ex);
        } finally {
     ...
     * @throws GpuRuntimeException if this file handle represents a directory, if it is a {@link FileType#Classpath} or
     *                             {@link FileType#Internal} file, or if it could not be written.
     */
    public OutputStream write(boolean append) {
        if (type == FileType.Classpath) throw new GpuRuntimeException("Cannot write to a classpath file: " + file);
        if (type == FileType.Internal) throw new GpuRuntimeException("Cannot write to an internal file: " + file);
        parent().mkdirs();
        try {
            ...
            if (file().isDirectory())
                throw new GpuRuntimeException("Cannot open a stream to a directory: " + file + " (" + type + ")", ex);
            throw new GpuRuntimeException("Error writing file: " + file + " (" + type + ")", ex);
        }
    }
    ...
    public void write(InputStream input, boolean append) {
        ...
        try {
            ...
            throw new GpuRuntimeException("Error stream writing to file: " + file + " (" + type + ")", ex);
        } finally {
            StreamUtils.closeQuietly(input);
     ...
     *
     * @param append  If false, this file will be overwritten if it exists, otherwise it will be appended.
     * @param charset May be to use the default charset.
     * @throws GpuRuntimeException if this file handle represents a directory, if it is a {@link FileType#Classpath} or
     *                             {@link FileType#Internal} file, or if it could not be written.
     */
     ...
     * array.
     *
     * @throws GpuRuntimeException if this file is an {@link FileType#Classpath} file.
     */
    public FileHandle[] list() {
        if (type == FileType.Classpath) throw new GpuRuntimeException("Cannot list a classpath directory: " + file);
     ...
     *
     * @throws GpuRuntimeException if this file is the root.
     */
    public FileHandle sibling(String name) {
        if (file.getPath().length() == 0) throw new GpuRuntimeException("Cannot get the sibling of the root.");
    ...
    /**
     * @throws GpuRuntimeException if this file handle is a {@link FileType#Classpath} or {@link FileType#Internal} file.
     */
    public void mkdirs() {
        if (type == FileType.Classpath) throw new GpuRuntimeException("Cannot mkdirs with a classpath file: " + file);
        if (type == FileType.Internal) throw new GpuRuntimeException("Cannot mkdirs with an internal file: " + file);
        file().mkdirs();
    }
    ...
    public boolean delete() {
        if (type == FileType.Classpath) throw new GpuRuntimeException("Cannot delete a classpath file: " + file);
        if (type == FileType.Internal) throw new GpuRuntimeException("Cannot delete an internal file: " + file);
        return file().delete();
    }
     ...
     * this handle is a directory, then 1) if the destination is a file, GpuRuntimeException is thrown, or 2) if the destination is
     * a directory, this directory is copied into it recursively, overwriting existing files, or 3) if the destination doesn't
     * exist, {@link #mkdirs()} is called on the destination and this directory is copied into it recursively.
     *
     * @throws GpuRuntimeException if the destination file handle is a {@link FileType#Classpath} or {@link FileType#Internal}
    ...
    public void copyTo(FileHandle dest) {
        ...
        if (dest.exists()) {
            if (!dest.isDirectory())
                throw new GpuRuntimeException("Destination exists but is not a directory: " + dest);
        } else {
            dest.mkdirs();
            if (!dest.isDirectory()) throw new GpuRuntimeException("Destination directory cannot be created: " + dest);
        }
     ...
     *
     * @throws GpuRuntimeException if the source or destination file handle is a {@link FileType#Classpath} or
     *                             {@link FileType#Internal} file.
     */
    public void moveTo(FileHandle dest) {
        switch (type) {
            case Classpath:
                throw new GpuRuntimeException("Cannot move a classpath file: " + file);
            case Internal:
                throw new GpuRuntimeException("Cannot move an internal file: " + file);
            case Absolute:
            case External:
    ...
    static public FileHandle tempFile(String prefix) {
        try {
            ...
            throw new GpuRuntimeException("Unable to create temp file.", ex);
        }
    }
    ...
    static private void copyFile(FileHandle source, FileHandle dest) {
        try {
            ...
            throw new GpuRuntimeException("Error copying source file: " + source.file + " (" + source.type + ")\n" //
