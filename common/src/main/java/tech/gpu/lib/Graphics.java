...
public interface Graphics {
    ...
    class BufferFormat {
         ...
         */
        final boolean coverageSampling;
     ...
     *
     * @param resizable weather application resizable or not.
     */
    ...
    /**
     * Create a new cursor represented by the {@link java.awt.image.BufferedImage}. The Pixmap must be in RGBA8888 format,
     ...
     * the image represented by the {@link java.awt.Cursor}. It is recommended to call this function in the main
     * render thread, and maximum one time per frame.
     *
     * @param cursor the mouse cursor as a {@link java.awt.Cursor}
     */
    void setCursor(Cursor cursor);

    PixelFormatConverter getPixelFormatConverter();
