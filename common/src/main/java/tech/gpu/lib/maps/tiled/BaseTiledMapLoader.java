...
import tech.gpu.lib.maps.ImageResolver;
import tech.gpu.lib.maps.MapObject;
import tech.gpu.lib.maps.MapProperties;
...
public abstract class BaseTiledMapLoader<P extends BaseTiledMapLoader.Parameters> extends AsynchronousAssetLoader<TiledMap, P> {
    ...
    /**
     * Gets a map of the object ids to the {@link MapObject} instances. Returns if
     * {@link #loadTiledMap(FileHandle, Parameters, ImageResolver)} has not been called yet.
     *
     * @return the map of the ids to {@link MapObject}, or if {@link #loadTiledMap(FileHandle, Parameters, ImageResolver)}
    ...
    protected Object castProperty(String name, String value, String type) {
        if (type == null || "string".equals(type) || "file".equals(type)) {
            ...
            throw new GpuRuntimeException("Wrong type given for property " + name + ", given : " + type
    ...
    protected void loadObjectProperty(final MapProperties properties, final String name, String value) {
        ...
        try {
            ...
            throw new GpuRuntimeException("Error parsing property [\" + name + \"] of type \"object\" with value: [" + value + "]",
                    exception);
        }
    }
