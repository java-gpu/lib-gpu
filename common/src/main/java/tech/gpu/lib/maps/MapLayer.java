...
public class MapLayer {
    ...
    /**
     * @return the layer's parent {@link MapLayer}, or if the layer does not have a parent
     **/
    ...
    public void setParent(MapLayer parent) {
        if (parent == this) throw new GpuRuntimeException("Can't set self as the parent");
        this.parent = parent;
    }
