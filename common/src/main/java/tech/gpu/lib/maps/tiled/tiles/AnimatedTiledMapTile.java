...
public class AnimatedTiledMapTile implements TiledMapTile {
    ...
    public void setTextureRegion(TextureRegion textureRegion) {
        throw new GpuRuntimeException("Cannot set the texture region of AnimatedTiledMapTile.");
    }
    ...
    public void setOffsetX(float offsetX) {
        throw new GpuRuntimeException("Cannot set offset of AnimatedTiledMapTile.");
    }
    ...
    public void setAnimationIntervals(int[] intervals) {
        if (intervals.length == animationIntervals.length) {
            ...
            throw new GpuRuntimeException("Cannot set " + intervals.length + " frame intervals. The given int[] must have a size of "
