...
import tech.gpu.lib.audio.AudioDevice;
import tech.gpu.lib.audio.AudioRecorder;
...
public interface Audio {
     ...
     * @throws tech.gpu.lib.ex.GpuRuntimeException in case the device could not be created
     */
     ...
     * @throws GpuRuntimeException in case the recorder could not be created
     */
     ...
     * is retrieved from the file specified via the {@link File}. Note that the complete audio data is loaded into RAM. You
     ...
     * @throws GpuRuntimeException in case the sound could not be loaded
     */
