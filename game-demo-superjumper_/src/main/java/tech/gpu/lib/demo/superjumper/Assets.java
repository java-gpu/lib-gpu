...
public class Assets {
    ...
    public static Texture loadTexture(String file) {
        return new Texture(ApplicationEnvironment.app, ApplicationEnvironment.files.internal(file).file());
    }
    ...
    public static void load() {
        ...
        font = new BitmapFont(ApplicationEnvironment.files.internal("data/font.fnt"), ApplicationEnvironment.files.internal("data/font.png"), false);

        music = ApplicationEnvironment.audio.newMusic(ApplicationEnvironment.files.internal("data/music.mp3"));
        music.setLooping(true);
        music.setVolume(0.5f);
        if (Settings.soundEnabled) music.play();
        jumpSound = ApplicationEnvironment.audio.newSound(ApplicationEnvironment.files.internal("data/jump.wav"));
        highJumpSound = ApplicationEnvironment.audio.newSound(ApplicationEnvironment.files.internal("data/highjump.wav"));
        hitSound = ApplicationEnvironment.audio.newSound(ApplicationEnvironment.files.internal("data/hit.wav"));
        coinSound = ApplicationEnvironment.audio.newSound(ApplicationEnvironment.files.internal("data/coin.wav"));
        clickSound = ApplicationEnvironment.audio.newSound(ApplicationEnvironment.files.internal("data/click.wav"));
    }
